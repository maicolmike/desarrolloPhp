...
<link href="css/estilosAgregar.css" rel="stylesheet">
...
<body>
    ...
    <div style="font-size-adjust: 20px; text-align:right; background:#333; color:#FFF;"> <?php echo "Bienvenido Usuario: ".$_SESSION['nombre']; ?> </div>
