...
class Medico
{
	...
	public function	Medicoporcitas($identificacion)
		{
			
			$this->Conexion=Conectarse();
			$sql="select * from medicos,citas where medicos.medIdentificacion='$identificacion' and citas.citMedico=medicos.idMedico";
