...
<page backtop="30mm" backbottom="17mm" backleft="17mm" backright="20mm">
	<page_header >
    ...
    <?php	
		...
		echo "<tr><td style='width:650px;font-size:12;text-align:justify;line-height:19px;'> Entre los suscritos a saber, por una parte ".$row->nombres_damnificado." 
		...
		echo "</table>";
		echo "<table border='0' style='border-collapse:collapse;border-color:#bee4fa'>";
		echo "<tr><td style='width:650;font-size:12;text-align:justify;line-height:19px;'> <br><br>
		...
		echo "<tr><td style='width:320px;font-size:12;text-align:left;'><br><br><br><br><br><br><br>_______________________________</td>  
                  <td style='width:320px;font-size:12;text-align:left;'><br><br><br><br><br><br><br>_______________________________ </td>
             </tr>";
		echo "</table>";
		
		echo "<table border='0' style='border-collapse:collapse;border-color:#bee4fa'>";
		echo "<tr><td style='width:320px;font-size:12;text-align:left;'>EL ARRENDATARIO-APODERADO</td>  
                  <td style='width:320px;font-size:12;text-align:left;'>EL ARRENDADOR-APODERADO </td>
             </tr>";
		echo "</table>";
		...
		echo "<tr><td style='width:320px;font-size:12;text-align:left;'>".$row->nombres_apoderado_damnificado." ".$row->apellidos_apoderado_damnificado."</td>  
                  <td style='width:320px;font-size:12;text-align:left;'>".$row->nombres_apoderado_arrendador." ".$row->apellidos_apoderado_arrendador."</td>
             </tr>";
		echo "</table>";
		
		echo "<table border='0' style='border-collapse:collapse;border-color:#bee4fa'>";
		echo "<tr><td style='width:320px;font-size:12;text-align:left;'>CC. ".$row->cedula_apoderado_damnificado."</td>  
                  <td style='width:320px;font-size:12;text-align:left;'>C.C.: ".$row->cedula_apoderado_arrendador." </td>
             </tr>";
		echo "</table>";
		
		echo "<table border='0' style='border-collapse:collapse;border-color:#bee4fa'>";
		echo "<tr><td style='width:320px;font-size:12;text-align:left;'>Celular No. ".$row->cel_apoderado_damnificado."</td>  
                  <td style='width:320px;font-size:12;text-align:left;'>Celular No. ".$row->cel_apoderado_arrendador." </td>
             </tr>";
		echo "</table>";
