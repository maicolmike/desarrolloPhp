...
<html lang="es">
  ...
  <body backtop="30mm" backbottom="15mm" backleft="13mm" backright="13mm">
...
<?php
    ...
    $row = mysqli_fetch_object($res);    // con esto no me dio error
		...
		echo"<h1 style='font-size:18;'>CONTRATO DE ARRENDAMIENTO No. 868600115231032017-".$row->numero_contrato."-0 DE 2019 </h1>";
		...
		echo"<p style='font-size:12;text-align:justify;line-height:19px;'>Entre los suscritos a saber, por una parte ".$row->nombres_damnificado."
			".$row->apellidos_damnificado.", mayor de edad, identificado (a) con la cédula de ciudadanía No. ".$row->cedula_damnificado.", y su APODERADO(A) el
       (a) Sr.(a) ".$row->nombres_apoderado_damnificado." ".$row->apellidos_apoderado_damnificado." , mayor de edad, identificado (a) con la cédula de
      ciudadanía  No. ".$row->cedula_apoderado_damnificado." quien adelante se denominará EL ARRENDATARIO, y por la otra parte ".$row->nombres_arrendador."
      ".$row->apellidos_arrendador.", mayor de edad, identificado (a) con la cédula de ciudadanía No." .$row->cedula_arrendador.", quien en adelante se denominará
      EL ARRENDADOR, hemos convenido celebrar el presente Contrato de Arrendamiento, el cual se regirá por las siguientes cláusulas: PRIMERA.- OBJETO DEL CONTRATO: EL ARRENDADOR, entrega a título de
    ...
    echo "<tr><td style='width:320px;font-size:12;text-align:left;line-height:19px;'><br><br><br><br><br><br><br><br><br><br>_______________________________</td>
              <td style='width:320px;font-size:12;text-align:left;line-height:19px;'><br><br><br><br><br><br><br><br><br><br>_______________________________ </td> </tr>";
    echo "<tr><td style='width:320px;font-size:12;text-align:left;line-height:19px;'>EL ARRENDATARIO-APODERADO</td>
              <td style='width:320px;font-size:12;text-align:left;line-height:19px;'>EL ARRENDADOR</td> </tr>";
    echo "<tr><td style='width:320px;font-size:12;text-align:left;line-height:19px;'>".$row->nombres_apoderado_damnificado." ".$row->apellidos_apoderado_damnificado."</td>
              <td style='width:320px;font-size:12;text-align:left;line-height:19px;'>".$row->nombres_arrendador." ".$row->apellidos_arrendador."</td> </tr>";
    echo "<tr><td style='width:320px;font-size:12;text-align:left;line-height:19px;'>C.C: ".$row->cedula_apoderado_damnificado."</td>
              <td style='width:320px;font-size:12;text-align:left;line-height:19px;'>C.C: ".$row->cedula_arrendador."</td> </tr>";
    echo "<tr><td style='width:320px;font-size:12;text-align:left;line-height:19px;'>Celular No. ".$row->cel_apoderado_damnificado."</td>
              <td style='width:320px;font-size:12;text-align:left;line-height:19px;'>Celular No. ".$row->cel_arrendador."</td> </tr>";
    echo "</table>";
