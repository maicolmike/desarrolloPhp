...
<?php
    ...
    $row = mysqli_fetch_object($res);    // con esto no me dio error
      ...
      EL ARRENDATARIO, y por la otra parte ".$row->nombres_arrendador." ".$row->apellidos_arrendador.", mayor de edad, identificado (a) con la cédula de ciudadanía
      No. ".$row->cedula_arrendador.", y el APODERADO-ARRENDADOR ".$row->nombres_apoderado_arrendador." ".$row->apellidos_apoderado_arrendador."
      mayor de edad, identificado (a) con la cédula de ciudadanía No. ".$row->cedula_apoderado_arrendador." quien en adelante se denominará EL ARRENDADOR, hemos convenido celebrar el
    ...
    echo "<tr><td style='width:320px;font-size:12;text-align:left;line-height:19px;'>EL ARRENDATARIO</td>
              <td style='width:320px;font-size:12;text-align:left;line-height:19px;'>EL ARRENDADOR-APODERADO</td> </tr>";
    echo "<tr><td style='width:320px;font-size:12;text-align:left;line-height:19px;'>".$row->nombres_damnificado." ".$row->apellidos_damnificado."</td>
    ...
    echo "<tr><td style='width:320px;font-size:12;text-align:left;line-height:19px;'>C.C: ".$row->cedula_damnificado."</td>
              <td style='width:320px;font-size:12;text-align:left;line-height:19px;'>C.C: ".$row->cedula_apoderado_arrendador."</td> </tr>";
    echo "<tr><td style='width:320px;font-size:12;text-align:left;line-height:19px;'>Celular No. ".$row->cel_damnificado."</td>
