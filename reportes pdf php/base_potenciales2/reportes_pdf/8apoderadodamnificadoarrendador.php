...
<?php
    ...
    $row = mysqli_fetch_object($res);    // con esto no me dio error
      ...
      (a) Sr.(a) ".$row->nombres_apoderado_damnificado." ".$row->apellidos_apoderado_damnificado." , mayor de edad, identificado (a) con la cédula de ciudadanía
      No. ".$row->cedula_apoderado_damnificado." quien adelante se denominará EL ARRENDATARIO, y por la otra parte ".$row->nombres_arrendador." ".$row->apellidos_arrendador.", mayor de 
      edad, identificado (a) con la cédula de ciudadanía No. ".$row->cedula_arrendador.", y el APODERADO-ARRENDADOR ".$row->nombres_apoderado_arrendador."
      ".$row->apellidos_apoderado_arrendador." mayor de edad, identificado (a) con la cédula de ciudadanía No. ".$row->cedula_apoderado_arrendador." quien en adelante se denominará EL ARRENDADOR, hemos convenido celebrar el
